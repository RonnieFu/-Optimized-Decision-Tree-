...
class DecisionTree:
    ...
    def _grow_tree(self,X,y,depth = 0):
        ...
        # TODO changed the way to get columns
        ...
        # TODO changed the way to get rows
    ...
    def _information_gain(self,feat_idx,y,X_column, split_thresh):
        ...
        return ig
    def _optimized_entropy_table_continuous(self):
        pass
    ...
    def _entropy_calculate_optimized(self,C1Y, C1N, C2Y, C2N, SIZE_LIST_1, SIZE_LIST_2,total_len):
        ...
        for c1y, c1n, c2y, c2n, size1, size2 in zip(C1Y, C1N, C2Y, C2N, SIZE_LIST_1, SIZE_LIST_2):
            ...
            entropy2 =  -(c2y/size2)*math.log2(c2y/size2) - (c2y/size2)*math.log2(c2y/size2)
            gini_list.append(weight1*entropy1+weight2*entropy2)
        return gini_list
